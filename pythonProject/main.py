...
firebase_admin.initialize_app(cred, {
    ...
    'storageBucket': "faceattendanceschools.appspot.com"
})
...
with open("student_data.txt", "w") as file:
    for student_id in studentIds:
        ...
        file.write(f"Major: {student_data['major']}\n")
        file.write(f"Starting Year: {student_data['starting_year']}\n")
        file.write(f"Total Attendance: {student_data['total_attendance']}\n")
        file.write(f"Standing: {student_data['standing']}\n")
        file.write(f"Year: {student_data['year']}\n")
        file.write(f"Last Attendance Time: {student_data['last_attendance_time']}\n")
        file.write("\n")
modeType = 2
counter = 0
id = -1
...
while True:
    ...
    if faceCurFrame:
        ...
        for encodeFace, faceLoc in zip(encodeCurFrame, faceCurFrame):
            ...
            # print("Matches Index", matchIndex)
